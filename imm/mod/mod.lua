...
function IMod:isExcluded()
    return self.mod == 'balatro_imm' or self.list.native or self.locked
end

function IMod:isHidden()
    return self.mod == 'balatro_imm' or self.list.native or self.hidden
end
